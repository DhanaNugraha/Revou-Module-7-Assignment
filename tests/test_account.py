...
def test_register_account(client, mock_token_data, mock_account_data, users_data_inject):
...
def test_update_account_details(client, mock_token_data, mock_account_id, mock_update_account_data, users_data_inject, account_data_inject):
