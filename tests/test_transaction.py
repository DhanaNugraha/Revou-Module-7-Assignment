...
# def test_initiate_transaction2(client, mock_token_data, mock_transaction_data):
#     with client.application.test_request_context(
#         "/transactions", method="POST", headers=mock_token_data, json=mock_transaction_data
#     ):
#         app.preprocess_request()
#         print(flask.request.user)

#         response = initiate_transaction(mock_transaction_data, flask.request.user)[0]
#         print(response)
